...
class MainWindow:
    def __init__(self, window):
        ...
        # funcionalidad y aspecto de bonotes
        self.boton = Button(self.frameBottons, text='dawd', width=15)
        self.button1 = Button(self.frameBottons, text='Gasto', command=lambda: self.getInsert('Gasto'), width=15) # Botón que llama a la ventana insertar movimiento, con parametro Gasto
        self.button2 = Button(self.frameBottons, text='Ingreso', command=lambda: self.getInsert('Ingreso'), width=15) # Botón que llama a la ventana insertar movimiento, con parametro Ingreso
        self.button3 = Button(self.frameBottons, text='Traspaso', command=lambda: self.getInsert('Traspaso'), width=15) # Botón que llama a la ventana insertar movimiento, con parametro Traspaso
        self.button4 = Button(self.frameBottons, text='Importar Movimientos', command=self.importarMov, width=15)

        # Empaquetado de bonotes, tablas y frames
